...
**Cooking drawers.** "Інструменти" opens the mobile drawer for ingredients, a manual timer, unit conversion, servings, helper access, sound, and people management. The helper and people management each use their own mobile drawer. Tools do not change the timeline's order.
